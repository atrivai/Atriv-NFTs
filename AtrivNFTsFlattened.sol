...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    constructor(string memory name_, string memory symbol_, string memory _baseURI, uint256  _maxSupply) {
        _name = name_;
        _symbol = symbol_;
        baseURI = _baseURI;
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        _totalSupply -= 1; // Decrement total supply
